...
if(nrow(raw_data %>% filter(Variant_Type!="fusion")) >= 1){
    ...
    res1 %>% plot_hist(use_log = use_log,fig=fig,min_n_sample_name=min_n_sample_name)
...
if(nrow(raw_data %>% filter(Variant_Type=="fusion")) >= 1){
    ...
    res2 %>% plot_hist(use_log = c(0,0),fig=paste(prefix,"_fusion.png",sep = ""),type = "fusion",min_n_sample_name=min_n_sample_name)
